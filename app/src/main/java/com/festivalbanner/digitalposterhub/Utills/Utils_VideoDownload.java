...
//        fileName = "VideoDemo.mp4";
        ...
        String folder = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" + Constance.FolderName;
    ...
    private void scanMedia(String path) {
        ...
        Uri uri = FileProvider.getUriForFile(context, "com.festivalbanner.provider", file);
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... sUrl) {
            ...
            try {
                ...
                location = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" +  Constance.FolderName + fileName;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= 19) {
                    ...
                    Uri uri = FileProvider.getUriForFile(context,"com.festivalbanner.provider", new File(location));
